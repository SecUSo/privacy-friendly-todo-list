...
object Helper {
    ...
    fun recurrencePatternToString(context: Context, recurrencePattern: TodoTask.RecurrencePattern?): String {
        return when (recurrencePattern) {
            TodoTask.RecurrencePattern.NONE -> context.resources.getString(R.string.none)
            TodoTask.RecurrencePattern.DAILY -> context.resources.getString(R.string.daily)
            TodoTask.RecurrencePattern.WEEKLY -> context.resources.getString(R.string.weekly)
            TodoTask.RecurrencePattern.MONTHLY -> context.resources.getString(R.string.monthly)
            TodoTask.RecurrencePattern.YEARLY -> context.resources.getString(R.string.yearly)
