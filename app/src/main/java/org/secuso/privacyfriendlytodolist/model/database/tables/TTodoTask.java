...
public class TTodoTask {
    ...
    public static final String COLUMN_DEADLINE_WARNING = "deadline_warning";


    // sql table creation
    public static final String TABLE_CREATE = "CREATE TABLE " + TABLE_NAME + "(" + COLUMN_ID +
            " INTEGER PRIMARY KEY AUTOINCREMENT, " + COLUMN_TOOD_LIST_ID + " INTEGER NOT NULL, " + COLUMN_TITLE + " TEXT NOT NULL, " +
            ...
            COLUMN_REMINDER_TIME + " NUMERIC NULL DEFAULT NULL, " + COLUMN_DEADLINE_WARNING + " NUMERIC DEFAULT NULL,  FOREIGN KEY (" + COLUMN_TOOD_LIST_ID + ") REFERENCES " + TTodoList.TABLE_NAME + "(" + TTodoList.COLUMN_ID + "));";
}
